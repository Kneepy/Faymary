...
import { ActivityArgs, ActivityInputCreate, ActivityInputUpdate, FindOneOptions } from "../dto";
...
export class ActivityService {
    ...
    public async findOne(args: ActivityArgs, options: FindOneOptions): Promise<Activity> {
