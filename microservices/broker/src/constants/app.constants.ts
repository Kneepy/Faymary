...
export const MESSAGES_MODULE_CONFIG = GetModuleConfig({port: 5004, pkgName: "messages", host: MESSAGES_MS_HOST, protoPath: GetProtoPath("messages"), serviceName: "MessagesSerivce"})
