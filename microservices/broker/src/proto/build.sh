...
# --ts_proto_opt=returnObservable=true всё возвращается как Observable
protoc --ts_proto_out=./ --ts_proto_opt=snakeToCamel=false --ts_proto_opt=nestJs=true --ts_proto_opt=returnObservable=true --experimental_allow_proto3_optional ./*.proto
